...
// Экспортируется для диагностики соединения (`connectionProbe.ts`) — значение
// НЕ менять и не выводить из env (rule 96): это и есть RU-обход.
export const SUPABASE_URL = 'https://api.sokratai.ru';
