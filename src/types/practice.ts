...
export const EGE_NUMBERS: Record<EGENumber, { name: string; topic: string; maxPoints: number; part: 1 | 2 }> = {
  ...
  7: { name: 'Выражения', topic: 'expressions', maxPoints: 1, part: 1 },
  8: { name: 'Функция', topic: 'function', maxPoints: 1, part: 1 },
  9: { name: 'Текстовые задачи', topic: 'word_problems', maxPoints: 1, part: 1 },
  10: { name: 'Прикладные задачи', topic: 'applied', maxPoints: 1, part: 1 },
  11: { name: 'График функции', topic: 'graph', maxPoints: 1, part: 1 },
