...
const TUTOR_LANDING_DESCRIPTION =
  "AI-проверка рукописных ДЗ по физике, математике, информатике. Сократовский диалог с учеником — не списывает у ChatGPT. Оплаты и расписание — бесплатно. 7 дней бесплатно — без карты. Потом 200 ₽ первый месяц.";
