      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative bg-card border-2 border-primary/20 shadow-2xl rounded-3xl p-8 max-w-sm w-full text-center overflow-hidden"
          >
            {/* Фон с лучами */}
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-tr from-orange-500 to-yellow-400 shadow-lg shadow-orange-500/40 mb-6"
            >
            ...
            <Button 
              onClick={onClose}
              size="lg"
              className="w-full bg-primary hover:bg-primary/90 text-primary-foreground rounded-2xl font-bold h-14 shadow-lg shadow-primary/20 transition-all active:scale-95"
            >
              КРУТО, ПРОДОЛЖАЕМ!
            </Button>
          </motion.div>
