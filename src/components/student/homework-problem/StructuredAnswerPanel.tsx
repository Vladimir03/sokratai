// ⚠️ DORMANT с 2026-07-28 — НЕ подключён ни на одном экране.
//
// Решение владельца: ученик отвечает на структурный тест ЦИФРАМИ, как на
// ЕГЭ/ОГЭ, а варианты видит в условии (ProblemContext → TaskOptionsList).
// Клик по вариантам тренирует узнавание вместо воспроизведения, а вся база
// Дианы — подготовка к экзамену. Файл сохранён на случай возврата к режиму
// «тренировка» (переключатель у репетитора обсуждался и отложен).
//
// options_json (2026-07-27, спека homework-choice-tasks): панель выбора
// вариантов структурного теста. Выбор сериализуется в строку и уходит
// СУЩЕСТВУЮЩИМ каналом ответа (checkAnswer / submission) — ни нового
// endpoint'а, ни нового message-типа. Балл считает сервер детерминированно.
//
