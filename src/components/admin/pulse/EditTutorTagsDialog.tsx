...
/**
 * Ручные CEO-теги репетитора (tutor_pilot_crm) — перенос из business/
 * (вкладка «Бизнес» удалена). Пишет в tutor_pilot_crm напрямую (admin-RLS).
 * Родитель должен монтировать с key={tutorId} — начальные значения
 * захватываются на mount.
 */
