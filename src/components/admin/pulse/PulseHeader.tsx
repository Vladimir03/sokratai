  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      <PulseMetricCard
        ...
        tooltip="Rolling run-rate: сумма последнего успешного платежа тарифа «AI-старт» каждого репетитора за последние 35 дней (30 дней подписки + 5 дней grace), за вычетом возвратов. Δ — сравнение с таким же окном неделю назад, НЕ выручка за неделю. Ручные гранты премиума не входят (они в «Платящие»)."
