    ...
    <Card animate={false}>
      <CardHeader>
        ...
        <p className="text-xs text-muted-foreground">
          Само-зарегистрированные за период (без заведённых репетитором вручную) → завершили онбординг →
          хоть раз написали (AI-чат или тред ДЗ, за всё время). Воронка активации репетиторов поимённо — во вкладке «Пульс».
        </p>
      </CardHeader>
      <CardContent>
