...
/**
 * Онбординг-активация v2 (T3) — одноразовый гейт «Подключить ученика».
 * Открывается при первой отправке ДЗ ученику без канала. Ссылка-первый способ
 * (hi-fi) + QR + «Отправить на email» (авто). Telegram/WhatsApp — той же ссылкой
 * (копировать). После подключения гейт больше не появляется.
 */
