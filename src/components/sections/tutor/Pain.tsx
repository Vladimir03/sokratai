...
const CARDS: PainCard[] = [
  {
    ...
    body:
      "Двадцать учеников прислали фото решений. Каждому нужен разбор его ошибок. Впереди три часа — а утром урок.",
  },
  {
    title: "«Кто это вообще прислал?»",
    body:
      "Фото летят в Telegram, WhatsApp, почту — без подписей и номеров заданий. Собрать работы дольше, чем проверить.",
  },
  {
    title: "Ученик застрял — пошёл в ChatGPT",
    body:
      "Писать вам поздно. ChatGPT выдал готовое решение — ученик списал. «ДЗ сдано», навыка нет.",
  },
  {
    title: "«Как у него дела?» — спрашивает мама",
    body:
      "Оценки в Excel, прогресс в переписках, остальное в голове. Свести отчёт по тридцати ученикам — два вечера.",
  },
];
