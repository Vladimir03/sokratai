...
const ITEMS: QA[] = [
  ...
  },
  {
    ...
    a: "Да, 7 дней бесплатно с полным AI-доступом — без карты. После trial покажем, что вы получили, и спросим, продолжать ли. Если да — 200 ₽ первый месяц (вместо 1 000 ₽), отмена в один клик. Если нет — AI выключится, базовая платформа (оплаты, расписание) останется. Дальше: 1 000 ₽/мес до 10 учеников, 2 000 ₽ до 20, 3 000 ₽ за 20+. Один час вашего времени — 1,5–2 тысячи рублей. Платформа окупается первой неделей использования.",
  },
  {
    q: "Что будет с моими учениками и данными после trial, если я не продолжу?",
    a: "Все данные сохранятся. Ученики, ДЗ, история проверок — всё на месте. Просто AI-слой выключится — новые ДЗ нельзя будет проверять автоматически. Базовая платформа (оплаты, расписание, профили) продолжит работать бесплатно. Захотите вернуть AI — один клик в настройках.",
  },
];
