  ...
  const values = [
    {
      ...
      description: "Ни родители, ни одноклассники, ни учителя не увидят твои ошибки. Твои трудности — только между тобой и ИИ. Никакого стыда или страха осуждения."
    },
    {
      icon: "💡",
    ...
    {
      icon: "🫂",
      title: "ИИ не раздражается от твоих вопросов",
      description: "В отличие от учителя, Сократ не вздохнет, когда ты не понял с первого раза. Отвечает эмпатично, с юмором и поддержкой — как понимающий друг. Переспрашивай сколько нужно."
    }
  ];
