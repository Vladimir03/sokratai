...
// Студенческий OG (запрос Ульяны 2026-07-20): ведёт с ПОЛЬЗЫ для ученика,
// а не «тебя пригласили»/репетиторский лендинг. Покрывает /invite/, /c/ и
// /login (ссылку входа из «Данные для входа» ученику).
const TITLE = "Сократ AI — разбери домашку сам, без ожидания репетитора";
const DESC =
  "Застрял на задаче? Спроси Сократа — подскажет шаг за шагом и поможет понять, а не просто даст ответ. В любое время, по любой домашке.";
