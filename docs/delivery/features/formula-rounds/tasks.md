...
**Job**: S1-2, R4-1
**Agent**: Claude Code
**Files**: `supabase/migrations/20260405083400_b315170e-7b05-4d42-941d-eb08b678cf2f.sql`, `supabase/migrations/20260405083626_e0d65b1c-8a42-48ad-9898-53d050973b78.sql`, `supabase/migrations/20260405084509_0bb67fba-2d33-48cc-aba4-45c8f1c134fb.sql`
...
**Job**: S2-4
**Agent**: Claude Code
**Files**: `supabase/functions/homework-api/index.ts`, `supabase/functions/homework-api/README.md`, `src/lib/formulaRoundApi.ts`, `src/hooks/useFormulaRound.ts`, `src/pages/StudentFormulaRound.tsx`, `src/App.tsx`
**AC**: AC-1, AC-7
...
- Result history is ordered by `created_at` in the current production schema
