-- Re-assert the canonical hw_reorder_tasks body in case an environment still
-- has a drifted version that does not keep homework_kb_tasks.sort_order in
-- sync with homework_tutor_tasks.order_num.
