-- View: kb_topics_with_counts
-- Aggregates task/material counts and subtopic names per topic.
-- Required by useTopics / useTopic hooks (src/hooks/useKnowledgeBase.ts).
