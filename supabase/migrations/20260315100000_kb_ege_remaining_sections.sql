-- Refresh EGE Physics remaining sections in KB catalog.
-- Sections covered: МКТ и термодинамика, Электродинамика, Квантовая физика, Атомная физика.
-- Специальные форматы КИМ (UUIDs ...0011, ...0012, ...0013) are NOT touched.
-- Uses stable UUIDs from 20260314120602.
...
BEGIN
  ...
  -- ── Смешанные цепи (repurpose d1000001-...000b, was Электромагнитная индукция)
  UPDATE kb_topics
  ...
  -- ── Оптика (repurpose d1000001-...000d, was Геометрическая оптика)
  --    Merge Волновая оптика (000e) tasks into it, then delete 000e.
  UPDATE kb_tasks
  ...
  -- ── Модель атома и атомного ядра (repurpose d1000001-...0010, was Атом и ядро)
  UPDATE kb_topics
  ...
  -- ── Закон радиоактивного распада (NEW) ───────────────────────────────────
  INSERT INTO kb_topics (name, section, exam, kim_numbers, sort_order)
  ...
  -- ══════════════════════════════════════════════════════════════════════════
  -- Bump Специальные форматы КИМ sort_order above Атомная физика
  -- ══════════════════════════════════════════════════════════════════════════
