...
--
-- Раньше уровни CEFR ограничивались A2/B1/B2/C1 (миграции 20260529180000 /
-- 20260529182149 для homework_tutor_tasks и 20260705120000 / 20260706090218
-- для kb_tasks). Эмилия ведёт учеников самого начального уровня и попросила
-- добавить DELF A1 — иначе селектор «Уровень CEFR» не предлагает A1, а прямой
-- insert A1 отклоняется CHECK-констрейнтом.
--
...
-- Backend rubric (languages-ege.ts) уже несёт DELF A1 écrite/orale рубрику.
