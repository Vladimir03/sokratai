-- Seed Тренировочный вариант 5 (физика ЕГЭ-2026) как миграция.
-- План: Часть 1 (1-20) из Варианта 4, №21/22/24 из Варианта 2, №23 из Варианта 4,
-- №25 из присланного скриншота (решение Егора получено 2026-06-06, D=40 см),
-- №26 из Варианта 1. Источник: supabase/seed/mock_exams_variant_5.sql.
-- Idempotent (ON CONFLICT DO NOTHING). variant_id 03660fb4-5247-5376-a0e9-2eb5faae844e.
--
-- 2026-06-06: задача 6 теперь использует 3 отдельные картинки
-- (image6_situation.png + image6_a.png + image6_b.png) вместо composite,
-- по feedback Vladimir + Егора.
--
-- Картинки задач (storage://mock-exam-variant-tasks/variant5/*) заливаются в
-- Storage вручную — см. docs/delivery/features/mock-exams-v1/source/storage-upload-checklist-v5.md
