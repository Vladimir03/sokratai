...
INSERT INTO public.mock_exam_variant_tasks (
  ...
  'manual',
  3,
  '1. Так как источники находятся с разных сторон от линзы, то для одного из них изображение должно быть действительным, а для другого – мнимым. Сделай два отдельных схематичных рисунка хода лучей.
