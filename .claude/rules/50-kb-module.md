...
- **Якорные предметы витрины:** `KB_SUBJECTS` += `maths`, `french` (pills видны до первых тем). Онбординг Эмилии/Светланы модераторами — миграции по образцу Милады `20260706140000` (ОБЕ роли tutor+moderator, инвариант выше).
