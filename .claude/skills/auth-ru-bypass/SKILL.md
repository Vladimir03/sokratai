---
name: auth-ru-bypass
description: "Авторизация SokratAI в РФ: обход блокировок через api.sokratai.ru, гарды и ожидание INITIAL_SESSION, email-подтверждение через email-verify, OAuth Yandex ID / VK ID (406-ФЗ), claim-код ученика и онбординг-активация v2, сброс пароля, минт свежей сессии после смены пароля, история инцидентов и ops-чеклисты Supabase. Загружай при работе с логином, регистрацией, OAuth, инвайтами или сессиями."
---

<!-- Извлечено из .claude/rules/96-auth-ru-bypass.md 2026-07-25. Текст ниже — ДОСЛОВНО прежнее
